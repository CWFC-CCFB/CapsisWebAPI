...
namespace Capsis.Handler.Tests
{
    [TestClass]
    public class CapsisHandlerArtemis2009Tests : AbstractCapsisHandlerTests
    {
        protected override Variant GetVariant()
        {
            return Variant.ARTEMIS;
        }
    }
}